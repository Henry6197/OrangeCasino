document.addEventListener('DOMContentLoaded', ()=>{
  ...
  const defs = [
    {id:'earn_2k', title:'Earn $2K', reward: 100, check:()=> (vc.readBalance() >= 2000)},
    {id:'earn_5k', title:'Earn $5K', reward: 250, check:()=> (vc.readBalance() >= 5000)},
    {id:'earn_10k', title:'Earn $10K', reward: 500, check:()=> (vc.readBalance() >= 10000)},
    {id:'earn_20k', title:'Earn $20K', reward: 1000, check:()=> (vc.readBalance() >= 20000)},
    {id:'earn_50k', title:'Earn $50K', reward: 2500, check:()=> (vc.readBalance() >= 50000)},
    {id:'earn_100k', title:'Earn $100K', reward: 5000, check:()=> (vc.readBalance() >= 100000)},
    {id:'earn_1m', title:'Earn $1M', reward: 50000, check:()=> (vc.readBalance() >= 1000000)},
    {id:'debt_1k', title:'Have $1K in debt', reward: 50, check:()=> (vc.readDebt() >= 1000)},
    {id:'debt_5k', title:'Have $5K in debt', reward: 200, check:()=> (vc.readDebt() >= 5000)},
    {id:'coal_escape', title:'Secret: Escape the factory using supervisor override', reward: 1000, check:()=> (localStorage.getItem('vc_coal_mine_escaped') === '1')},
    {id:'sell_kidney', title:'Sell a kidney', reward: 300, check:()=> (localStorage.getItem('vc_surgery_used') === '1')},
    {id:'sell_appendix', title:'Sell your appendix', reward: 150, check:()=> (localStorage.getItem('vc_appendix_used') === '1')},
    {id:'buy_course', title:"Buy Chad Moneybags' Course", reward: 500, check:()=> (localStorage.getItem('vc_chads_course_owned') === '1')},
  ];
